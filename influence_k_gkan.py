...
plt.plot([x+1 for x in range(args.epochs)], resutls_archit_2['test_acc'], 'bo-',label='GKAN Archit. 2 w. k='+str(args.k_GKAN),markersize=4, linewidth=1)  
plt.plot([x+1 for x in range(args.epochs)], resutls_archit_2_k2['test_acc'], 'mo-',label='GKAN Archit. 2 w. k='+str(args.k_GKAN+2),markersize=4, linewidth=1)  
plt.plot([x+1 for x in range(args.epochs)], resutls_archit_2_k3['test_acc'], 'ko-',label='GKAN Archit. 2 w. k='+str(args.k_GKAN+4),markersize=4, linewidth=1)  
